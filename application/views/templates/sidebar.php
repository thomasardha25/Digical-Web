...
<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">digical</div>

        <!-- <div class="sidebar-brand-icon">            
            <img src="<?= base_url('') ?>assets/img/logo/favicon.png" width="25px" height="auto" alt="Logo">
        </div>        
        <img src="<?= base_url('') ?>assets/img/logo/logo-putih.png" width="120px" height="auto" alt="Logo"> -->
    </a>
